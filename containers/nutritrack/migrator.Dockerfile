# NutriTrack — database migrator image
# https://github.com/sderosiaux/nutritrack
#
# Used by the db-init Kubernetes Job to run pnpm db:migrate && pnpm db:seed.
# Contains pnpm, tsx, and the full source tree — not suitable as the app image.
#
...
COPY --from=source  --chown=nextjs:nodejs /src .
